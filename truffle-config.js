...
module.exports = {
    ...
    networks: {
        ...
        bscmainnet: {
            ...
            provider: () =>
                new HDWalletProvider(
                    mnemonic,
                    `https://speedy-nodes-nyc.moralis.io/e3771a4194ca1a8d20c96277/bsc/mainnet`
                ),
            network_id: 56,
            gas: 10000000,
        },
        mumbai: {
            ...
            provider: () =>
                new HDWalletProvider(
                    mnemonic,
                    `https://speedy-nodes-nyc.moralis.io/e3771a4194ca1a8d20c96277/polygon/mumbai`
                ),
            network_id: 80001,
            gas: 10000000,
        },
    ...
    api_keys: {
        etherscan: "3CQMI6V1GX34DVAWFC8H4KAMB3W559PE1V",
    },
};
